...
b2Fixture* b2Utils::AddRectangleFixture(b2Body* body, int width, int height, int x, int y, float restitution, float density, float friction, bool isSensor) {
...
b2Fixture* b2Utils::AddCircleFixture(b2Body* body, int radius, int x, int y, float restitution, float density, float friction, bool isSensor) {
...
b2Fixture* b2Utils::AddChainLoopFixture(b2Body* body, std::vector<sf::Vector2i> t_vertices, float restitution, float density, float friction, bool isSensor) {
